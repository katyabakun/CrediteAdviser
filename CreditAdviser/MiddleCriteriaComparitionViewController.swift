...
class MiddleCriteriaComparitionViewController: UITableViewController{
...
extension MiddleCriteriaComparitionViewController{
    ...
    func saveOption(){
        ...
        if isSpojne{
            self.navigationController?.pushViewController(ExtendedCriteriaViewController.init(initWithData: chosenBank, s0: s0, s1: s1,navTitle: rows[2]), animated: true)
        }else{
